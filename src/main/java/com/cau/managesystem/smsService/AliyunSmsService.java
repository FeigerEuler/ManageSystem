...
public class AliyunSmsService {
    ...
    public static void addSignature(String content, String signature) {
        String host = "https://zwp.market.alicloudapi.com";
        String path = "/sms/edittemplete";
        String method = "POST";
        String appcode = "344eefed9fdb4760b711b784af5f6a70";
    ...
    public static void queryStatus(String templateId){
        String host = "https://zwp.market.alicloudapi.com";
